...
-- It merges all 33 migrations in sequential order and can be run directly in the
-- Supabase SQL Editor.
-- ==============================================================================
...
-- >>>>> Migration: 20260924000400_whatsapp_scope.sql <<<<<
...
-- >>>>> Migration: 20260924000500_trigger_function_grants.sql <<<<<
