...
CREATE POLICY "Administrators manage product images" ON "storage"."objects" TO "authenticated" USING ((("bucket_id" = 'products'::"text") AND "public"."is_admin"())) WITH CHECK ((("bucket_id" = 'products'::"text") AND "public"."is_admin"()));



CREATE POLICY "Admins manage payment proof files" ON "storage"."objects" TO "authenticated" USING ((("bucket_id" = 'payment-proofs'::"text") AND "public"."is_admin"())) WITH CHECK ((("bucket_id" = 'payment-proofs'::"text") AND "public"."is_admin"()));



CREATE POLICY "Customers delete own review photos" ON "storage"."objects" FOR DELETE TO "authenticated" USING ((("bucket_id" = 'review-images'::"text") AND ("owner_id" = ( SELECT ("auth"."uid"())::"text" AS "uid"))));



CREATE POLICY "Customers upload own payment proofs" ON "storage"."objects" FOR INSERT TO "authenticated" WITH CHECK ((("bucket_id" = 'payment-proofs'::"text") AND (("storage"."foldername"("name"))[1] = ( SELECT ("auth"."uid"())::"text" AS "uid"))));



CREATE POLICY "Customers upload own review photos" ON "storage"."objects" FOR INSERT TO "authenticated" WITH CHECK ((("bucket_id" = 'review-images'::"text") AND ("owner_id" = ( SELECT ("auth"."uid"())::"text" AS "uid")) AND (("storage"."foldername"("name"))[1] = ( SELECT ("auth"."uid"())::"text" AS "uid"))));



CREATE POLICY "Customers view own payment proofs files" ON "storage"."objects" FOR SELECT TO "authenticated" USING ((("bucket_id" = 'payment-proofs'::"text") AND (("storage"."foldername"("name"))[1] = ( SELECT ("auth"."uid"())::"text" AS "uid"))));
