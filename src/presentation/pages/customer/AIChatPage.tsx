...
import { askBeautyAdvice } from '@infrastructure/repositories';
...
export const AIChatPage: React.FC = () => {
    ...
    return (
        <div className="max-w-4xl mx-auto p-4 sm:p-6 h-[calc(100vh-100px)] md:h-[calc(100vh-120px)] flex flex-col animate-fadeIn">
            <div className="mb-3">
