...
import { isNative, nativePlatform } from '@infrastructure/auth/platform';
import { hideNativeSplash } from '@infrastructure/native/bootstrap';
import { pathFromDeepLink } from '@infrastructure/native/deepLinks';
import { registerForPush } from '@infrastructure/native/push';
