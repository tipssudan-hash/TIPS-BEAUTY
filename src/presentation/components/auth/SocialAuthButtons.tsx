...
import { signInWithSocial, socialSignInAvailable, type SocialProvider } from '@infrastructure/auth/providers';
import { shouldOfferApple } from '@infrastructure/auth/platform';
import { socialAuthErrorMessage } from '@application/errors';
