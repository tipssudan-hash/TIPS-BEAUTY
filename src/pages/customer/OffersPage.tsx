...
import { fetchBanners, fetchOffers } from '../../lib/api';
import { offerEndsLabel, offerScopeLabel, offerValueLabel } from '../../lib/offers';
...
export const OffersPage: React.FC = () => {
    ...
    return (
        <div className="max-w-4xl mx-auto p-4 md:p-8">
            <div className="mb-6">
                <h1 className="text-2xl font-bold text-gray-800 flex items-center gap-2"><Percent className="w-6 h-6 text-brand-blue" /> العروض</h1>
                <p className="text-sm text-gray-500 mt-1">الأسعار المعروضة هي ما ستدفعينه عند إتمام الطلب — لا مفاجآت.</p>
            </div>
            <PageState
                loading={loading}
                error={error}
